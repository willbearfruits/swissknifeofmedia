  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="glass w-full max-w-md p-8 rounded-2xl shadow-2xl border-t-4 border-accent">
        <h2 className="text-3xl font-bold text-primary mb-2 text-center">{isLogin ? 'Media Lab Access' : 'Join the Workshop'}</h2>
        <p className="text-slate-500 text-center mb-8">{isLogin ? 'Access your synth & art tools' : 'Create your creative profile'}</p>
