...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-accent hover:bg-red-600 text-white focus:ring-red-500",
    ...
    ghost: "bg-transparent text-slate-700 hover:bg-red-50 hover:text-red-700 focus:ring-red-200"
  };
